...
export const QWEN_3_6_CONFIG = {
  firstParty: LOCAL_DEFAULT_MODEL,
  bedrock: LOCAL_DEFAULT_MODEL,
  vertex: LOCAL_DEFAULT_MODEL,
  foundry: LOCAL_DEFAULT_MODEL,
  openai: LOCAL_DEFAULT_MODEL,
